...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
    ...
    if(t<FAR){
        ...
        */
        ...
        // Obviously, the reflected
        // efracted colors will involve lit values from their respective
...
export default class implements iSub {
  ...
  channels() {
    return [webglUtils.TEXTURE2, webglUtils.TEXTURE4];
  }
}
