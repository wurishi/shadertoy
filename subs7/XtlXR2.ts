...
{
 float noise = Turbulence(position * NoiseFrequency + Animation*iTime*0.24, 0.1, 1.5, 0.03) * NoiseAmplitude;
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
 ...
 float roty = -iMouse.x * 0.01+iTime*0.1;
 float zoom = 5.0;
 // camera
...
export default class implements iSub {
  ...
  channels(): { path?: string; type: number; fi?: number; f?: string; video?: any; canvas?: any; }[] {
      return [
